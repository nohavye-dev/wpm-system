...
list_entries). Follow these rules every turn:
...
2. MEMORY FIRST. Before reading files or searching the codebase, call
   ...
   memory. Then verify: if the entry is high-confidence (>0.7) and recently
   validated, trust it. If it is old, low-confidence, or has active
