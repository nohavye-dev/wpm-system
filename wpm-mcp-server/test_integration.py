...
async def main():
    ...
    async with stdio_client(params) as (read, write), ClientSession(read, write) as session:
        ...
        d1 = json.loads(r.content[0].text)  # pyright: ignore[reportAttributeAccessIssue]
        ...
        d2 = json.loads(r.content[0].text)  # pyright: ignore[reportAttributeAccessIssue]
        ...
        d3 = json.loads(r.content[0].text)  # pyright: ignore[reportAttributeAccessIssue]
        ...
        d4 = json.loads(r.content[0].text)  # pyright: ignore[reportAttributeAccessIssue]
        ...
        d = json.loads(r.content[0].text)  # pyright: ignore[reportAttributeAccessIssue]
