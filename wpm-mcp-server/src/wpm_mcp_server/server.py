...
def wpm_bootstrap() -> str:
    return (
        ...
        "actual files/configs, correct type, and the source that matches the "
        "evidence (rule 7, never over-declare): official_doc for facts read "
        "from README or docs, observed_code for facts read directly in "
        "configs, CI or code, agent_inference for anything inferred or "
        "assumed.\n"
        "\n"
