...
e1 = repo.store_entry(type_="insight", content="SQLite virtual tables support TEXT primary keys", source="agent_inference")
try:
...
e2 = repo.store_entry(type_="insight", content="SQLite virtual tables do not support TEXT primary keys", source="observed_code")
